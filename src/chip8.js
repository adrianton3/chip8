...
(function() {
  ...
  Chip8 = function() {
    ...
    tick = function() {
      var X, Y, height, i, instruction, instructionHi, instructionLo, j, k, keyState, l, line, m, n, ref, ref1, ref2, value;
      if (waitingForKey) {
        return;
      }
      ...
      switch (0xF0 & instructionHi) {
        ...
        case 0xD0:
          ...
          for (i = k = 0, ref = height; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
            line = memory[I + i];
            for (j = l = 0; l < 8; j = ++l) {
              if (line & 0x80) {
        ...
        case 0xF0:
          switch (instructionLo) {
            ...
            case 0x33:
              ...
              break;
            case 0x55:
              for (i = m = 0, ref1 = X; 0 <= ref1 ? m <= ref1 : m >= ref1; i = 0 <= ref1 ? ++m : --m) {
                memory[I + i] = V[i];
              }
              break;
            case 0x65:
              for (i = n = 0, ref2 = X; 0 <= ref2 ? n <= ref2 : n >= ref2; i = 0 <= ref2 ? ++n : --n) {
                V[i] = memory[I + i];
              }
          }
          break;
